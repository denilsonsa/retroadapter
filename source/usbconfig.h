 ...
 */
#define  USB_CFG_DEVICE_ID       0x01, 0x32 /* obdev's shared PID for HIDs */
 ...
 * USBID-License.txt!
 */
#define USB_CFG_DEVICE_VERSION  0x01, 0x04
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'R', 'e', 't', 'r', 'o', ' ', 'A', 'd', 'a', 'p', 't', 'e', 'r'
